...
public class ExceptionDemo5 {
	...
	public static void main(String[] args) {
		try {
			ExceptionDemo5.saveImage("https://mimgnews.pstatic.net/image/311/2020/02/18/0001113527_001_20200218135610361.jpg?type=w540");
	...
	// 예외처리를 savaImage() 메소드를 호출한 측에 위임하기
