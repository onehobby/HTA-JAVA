...
public class DataService {
	...
	public void printDataStatByMonth() {
		...
		for (Data data : datas) {
			String day = data.getDay();						// "01-01, "01-12", "02-21"
			String monthString = day.substring(0, 2);		// "01"	   "01"     "02"
			int month = 0;
	...
	public void printDataStat() {
		// 최다 사고발생 시도, 최다 사고발생 월, 최다 사고발생 일, 최다 사고발생 요일, 최다 사고발생 유형
