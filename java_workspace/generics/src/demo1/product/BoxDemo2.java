...
//		box1.add(new SmartPhone("아이폰", 1600000, "010-2222-2222", "192.168.10.100"));
...
//		box2.add(new Tv("초대형 텔레비젼", 5000000, 100.5));
		box2.add(new SmartPhone("아이폰", 1600000, "010-2222-2222", "192.168.10.100"));
		...
		box3.add(new SmartPhone("아이폰", 1600000, "010-2222-2222", "192.168.10.100"));
	}
}
