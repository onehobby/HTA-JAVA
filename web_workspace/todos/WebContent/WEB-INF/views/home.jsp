		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body">
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="row mb-3">
											...
											<div class="col-3">
												<button type="button" class="btn btn-outline-secondary btn-sm" onclick="openTodoDetailModal(${todo.no}); detail(${todo.no })">
												<fmt:message key="button.label.detail" /> </button>
											</div>
										</div>
					...
					<div class="row">
						<div class="col-12 text-center"><button class="btn btn-outline-dark btn"><fmt:message key="button.label.more"></fmt:message> </button></div>
					</div>
				</div>
			</div>
		</div>
