	...
	<div class="navi">
		...
		<%		
			...
			if("title".equals(condition)) {
				boards = boardDao.getAllPostsByTitle(keyword);
			} else if("writer".equals(condition)) {
				boards = boardDao.getAllPostsByWriter(keyword);
			} else if("content".equals(condition)) {
				boards = boardDao.getAllPostsByContent(keyword);
			} else {
				boards = boardDao.getAllPosts();
			}
