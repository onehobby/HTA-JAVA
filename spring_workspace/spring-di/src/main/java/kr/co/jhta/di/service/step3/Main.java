...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*
		 * 1. Reporter객체는 더이상 자신의 의존하는 객체를 생성하지 않는다.
		 * 2. Reporter객체는 어떤 종류의 객체가 필요한지 그리고, 필요한 객체를
		 *    전달받은 setter 메소드를 가지고 있다.
		...
		// Reporter객체가 의존하는 Output객체류(ConsoleOutput일수도, FileOutput일수도)가 Reporter객체에게 제공되는 순간이다.
